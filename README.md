...
[Students might benefit a quick description of what happens, here, when "Kanye West" wants to be referred to a "Yeezy".  I assume he doesn't want "Yeezy West", but... wouldn't that happen automatically?  And ... what if the contractor *wants* his name to be *only* "Yeezy" in this database?  Is that possible, or does that break??  
Same issue with the setter method, below - "wants to be referred to only as 'Yeezy' "]
